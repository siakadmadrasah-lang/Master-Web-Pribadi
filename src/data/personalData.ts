...
export const publicationsList: Publication[] = [
  ...
  },
  {
    ...
    videoUrl: "https://www.tiktok.com/@jaenalmaskun",
    featured: true
  },
  {
    id: "pub-3",
  ...
  },
  {
    ...
    videoUrl: "https://www.instagram.com/reel/C3abc123xyz/"
  },
  {
    id: "pub-5",
...
export const agendaList: AgendaItem[] = [
  {
    ...
    type: "Kajian Kitab",
    status: "Rutin",
    description: "Kajian mendalam pembacaan teks kitab klasik Ta'lim Muta'allim seputar adab pencari ilmu dan metode belajar efektif.",
    fileUrl: "https://raw.githubusercontent.com/siakadmadrasah-lang/Master-Web-Pribadi/main/public/materi-talim-mutaallim.pdf",
    fileName: "Silabus-Kajian-Talim-Mutaallim-2026.pdf",
    fileSize: "1.4 MB",
    fileType: "PDF",
    imageUrl: "https://images.unsplash.com/photo-1585036156171-384164a8c675?auto=format&fit=crop&w=1000&q=80"
  },
  {
    id: "ag-2",
    ...
    type: "Pelatihan Guru",
    status: "Akan Datang",
    description: "Pelatihan penyusunan bahan ajar digital, lembar kerja siswa interaktif, dan integrasi media pembelajaran Kurikulum Merdeka.",
    fileUrl: "https://raw.githubusercontent.com/siakadmadrasah-lang/Master-Web-Pribadi/main/public/panduan-workshop-guru.pptx",
    fileName: "Slide-Workshop-Modul-Digital-Interaktif.pptx",
    fileSize: "4.8 MB",
    fileType: "PPTX",
  ...
  },
  {
    ...
    status: "Akan Datang",
    description: "Strategi pendampingan anak di era digital dengan pendekatan cinta Al-Qur'an dan penguatan keteladanan keluarga.",
    fileUrl: "https://raw.githubusercontent.com/siakadmadrasah-lang/Master-Web-Pribadi/main/public/brosur-seminar-parenting.pdf",
    fileName: "Brosur-Seminar-Parenting-Alpha.pdf",
    fileSize: "2.1 MB",
    fileType: "PDF",
  ...
  },
  {
    ...
    status: "Rutin",
    description: "Pendampingan intensif kaidah makharijul huruf, tajwid praktis, dan pemahaman makna ayat-ayat pendidikan Islam.",
    fileUrl: "https://raw.githubusercontent.com/siakadmadrasah-lang/Master-Web-Pribadi/main/public/modul-tahsin-santri.pdf",
    fileName: "Modul-Tahsin-Fahmul-Ayat.pdf",
    fileSize: "3.2 MB",
    fileType: "PDF",
...
export const defaultHeaderLogo: HeaderLogoConfig = {
  type: 'custom_image',
  monogramText: 'HJ',
  brandName: 'GARDA',
  badgeText: 'MADRASAH',
...
export const defaultAgendaCategories: string[] = [
  'Kajian Kitab',
  'Pelatihan Guru',
  'Seminar Nasional',
  'Bimbingan Santri',
...
export const defaultMediaChannels: MediaChannelAccount[] = [
  {
    id: "channel-yt",
    platform: "youtube",
...
export const sampleYouTubeVideos: YouTubeChannelVideo[] = [
  {
    id: "yt-vid-1",
    videoId: "F32o6bO2g7Y",
    title: "Tutorial & Panduan Implementasi Kurikulum Merdeka Madrasah Terpadu",
    description: "Video panduan komprehensif implementasi modul ajar, capaian pembelajaran, dan asesmen autentik di lingkungan madrasah ibtidaiyah.",
    thumbnail: "https://img.youtube.com/vi/F32o6bO2g7Y/hqdefault.jpg",
    thumbnailUrl: "https://img.youtube.com/vi/F32o6bO2g7Y/hqdefault.jpg",
    videoUrl: "https://www.youtube.com/watch?v=F32o6bO2g7Y",
    platform: "youtube",
  ...
  },
  {
    id: "yt-vid-2",
    videoId: "kYJzBw_jQ-M",
    title: "Kajian Rutin Kitab Ta'lim Muta'allim: Adab Menuntut Ilmu & Keberkahan Guru",
    description: "Rekaman kajian kitab kuning mendalami nilai-nilai adab penuntut ilmu, akhlak santri, dan rahasia keberkahan ilmu pengetahuan.",
    thumbnail: "https://img.youtube.com/vi/kYJzBw_jQ-M/hqdefault.jpg",
    thumbnailUrl: "https://img.youtube.com/vi/kYJzBw_jQ-M/hqdefault.jpg",
    videoUrl: "https://www.youtube.com/watch?v=kYJzBw_jQ-M",
    platform: "youtube",
    channelName: "Ust. Jaenal Maskun Official",
    duration: "45:30",
    publishedAt: "1 pekan lalu",
    views: "2.8K tayangan"
  }
];

export const defaultYouTubeVideos: YouTubeChannelVideo[] = [
  {
  ...
  },
  {
    ...
    description: "Pemanfaatan limbah kertas karya santri Izzati menjadi wadah pensil yang estetik dan bernilai guna.",
  ...
  },
  {
    ...
    description: "Kreativitas santri madrasah dalam proyek penguatan profil pelajar Pancasila & Rahmatan Lil Alamin.",
  ...
  },
  {
    ...
    description: "Kreasi santriwati Safa mengolah limbah anorganik menjadi perlengkapan belajar yang bermanfaat.",
  ...
  },
  {
    ...
    description: "Pelaksanaan Kegiatan Pembiasaan Sholat Dhuha, Tadarus Al-Qur'an, dan Asmaul Husna.",
  ...
  },
  {
    ...
    videoId: "MGtw6vuTpQ8",
    title: "VOLLY CERIA",
    description: "Kegiatan olahraga voli ceria meningkatkan kebugaran jasmani dan silaturahmi GTK madrasah.",
  ...
  },
  {
    ...
    description: "Rihlah religi ziarah auliya dan sesepuh pejuang Islam se-Kabupaten Banyumas.",
  ...
  },
  {
    ...
    description: "Keceriaan dan kebersamaan di lingkungan madrasah bersama para pendidik dan peserta didik.",
  ...
  },
  {
    ...
    description: "Dokumentasi perjalanan spiritual ziarah makam wali Banyumas meneladani jejak dakwah.",
  ...
  {
    id: "tiktok-vid-1",
    videoId: "7320000000000000001",
    title: "Kutipan Hikmah Santri: Adab & Keberkahan Menuntut Ilmu di Madrasah",
    description: "Pesan singkat penuh inspirasi tentang keutamaan tawadhu', adab kepada guru, dan semangat belajar santri.",
    thumbnail: "https://images.unsplash.com/photo-1585036156171-384164a8c675?auto=format&fit=crop&w=800&q=80",
    thumbnailUrl: "https://images.unsplash.com/photo-1585036156171-384164a8c675?auto=format&fit=crop&w=800&q=80",
    videoUrl: "https://www.tiktok.com/@jaenalmaskun",
    platform: "tiktok",
    channelName: "Ust. Jaenal Maskun (@jaenalmaskun)",
    publishedAt: "Siaran TikTok",
    views: "12.8K Pengikut"
  },
  {
    id: "tiktok-live-1",
    videoId: "live",
    title: "Siaran Langsung Dakwah & Tanya Jawab Fikih Santri",
    description: "Kajian siaran langsung interaktif membahas adab harian, tanya jawab hukum Islam, dan motivasi mengajar.",
    thumbnail: "https://images.unsplash.com/photo-1519452635265-7b1fbfd1e4e0?auto=format&fit=crop&w=800&q=80",
    thumbnailUrl: "https://images.unsplash.com/photo-1519452635265-7b1fbfd1e4e0?auto=format&fit=crop&w=800&q=80",
    videoUrl: "https://www.tiktok.com/@jaenalmaskun/live",
    platform: "tiktok",
    channelName: "Ust. Jaenal Maskun (@jaenalmaskun)",
    publishedAt: "Siaran Langsung",
    views: "Live Streaming"
  }
];

export const defaultYouTubeChannelConfig: YouTubeChannelConfig = {
  enabled: true,
  channelHandle: "@jaenalmaskunofficial3977",
...
export const defaultSiteContent: SiteContentConfig = {
  ...
  agenda: agendaList,
  agendaCategories: defaultAgendaCategories,
  gallery: galleryList,
  youtubeChannel: defaultYouTubeChannelConfig,
  youtubeVideos: defaultYouTubeVideos,
  mediaChannels: defaultMediaChannels,
  visibility: {
    hero: true,
    about: true,
    pillars: true,
...
export const defaultStickyFooterConfig: StickyFooterConfig = {
  enabled: true,
  showOnDesktop: true,
  showOnMobile: true,
  position: 'floating',
